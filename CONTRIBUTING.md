...
request](https://github.com/cisagov/terraform-state-read-role-tf-module/pulls), you
...
```console
cd terraform-state-read-role-tf-module
pyenv virtualenv <python_version_to_use> terraform-state-read-role-tf-module
pyenv local terraform-state-read-role-tf-module
